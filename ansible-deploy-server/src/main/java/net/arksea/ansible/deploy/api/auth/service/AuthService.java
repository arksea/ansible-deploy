...
public class AuthService implements IAuthService {
    ...
    private final Map<String,Set<Permission>> rolePerms = new HashMap<>();
    ...
    public Set<String> getPermissionsByUserId(long id) {
        ...
        Set<Role> roleSet = op.get().getRoles();
    ...
    public Set<String> getPermissionsByRoles(Collection<Role> roles) {
        return getByRoles(roles.stream().map(Role::getRole).collect(Collectors.toList()));
    }

    public Set<String> getByRoles(Collection<String> roles) {
