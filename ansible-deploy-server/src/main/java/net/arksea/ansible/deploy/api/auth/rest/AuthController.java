...
public class AuthController {
    ...
    public String getUserPermissions(@CurrentUser UserDetailsImpl currentUser, final HttpServletRequest httpRequest) {
        ClientInfo info = clientInfoService.getClientInfo(currentUser, httpRequest);
    ...
    public String getUserRoles(@CurrentUser UserDetailsImpl currentUser, final HttpServletRequest httpRequest) {
        ClientInfo info = clientInfoService.getClientInfo(currentUser, httpRequest);
        String reqid = (String)httpRequest.getAttribute("restapi-requestid");
